...
// BrandingFooter closes out every generated report (PDF: a closing line
// after the last table; XLSX: a trailing "About" sheet).
const BrandingFooter = "Generated by KOSH — a Family Wealth Tracker by Jenish Jain, built to ease up his own personal finance. Available at kosh.jenishjain.in"
